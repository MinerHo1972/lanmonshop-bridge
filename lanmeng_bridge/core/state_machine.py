...
_ALLOWED_TRANSITIONS = {
    ...
    STATE_JKY_CREATED: [STATE_JKY_SHIPPED, STATE_FAILED, STATE_JKY_CANCELLED, STATE_DONE],
    ...
    STATE_SKIPPED: [STATE_AUDITED],  # 补映射后重新递交
    STATE_JKY_CANCELLED: [],
    STATE_CANCELLED: [],
}

# 终态不可再跳转
_TERMINAL_STATES = {STATE_DONE, STATE_JKY_CANCELLED, STATE_CANCELLED}
